                    ...
                    <Link key={product.id} to={`/product/${product.id}`} className="group cursor-pointer flex-shrink-0 w-56 sm:w-64 snap-start flex flex-col">
                      ...
                      {product.stock <= 0 ? (
                        <div className="flex flex-col gap-1.5">
                          <span className="w-full py-2 bg-gray-200 text-gray-500 text-xs font-bold rounded-full flex items-center justify-center cursor-not-allowed">
                            Agotado
                          </span>
                          <button
                            ...
                            className="w-full py-2 bg-[#25D366] hover:bg-[#128C7E] text-white text-xs font-bold rounded-full flex items-center justify-center gap-1.5 transition-colors"
                          >
      ...
      {!loading && products.length > 0 && (
        <section className="py-20 bg-white border-t border-gray-100">
          <div className="max-w-7xl 2xl:max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 gap-x-8 gap-y-12">
